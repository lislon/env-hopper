  ...
  return (<label>
    <div className="flex">
      <input ref={inputRef} type="text" value={value}
               className="dark:text-gray-000 py-1 px-2 dark:bg-gray-700 rounded-l w-full dark:border-0 border" readOnly={true} />
        <div className="dark:bg-gray-700 flex items-center rounded-r">
          ...
          >
            ...
            <span ref={successIconRef} className={copied ? 'inline-flex items-center' : 'hidden'}>
