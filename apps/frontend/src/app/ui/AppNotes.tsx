    ...
    <div className="flex">
      <div className="py-1 pr-2" title="Credentials for the app">
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <path d="M12 2a6 6 0 0 0-6 6v2H5a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V11a1 1 0 0 0-1-1h-1V8a6 6 0 0 0-6-6Zm4 8H8v-2a4 4 0 1 1 8 0Zm-8 4h4a1 1 0 0 1 0 2h-4a1 1 0 0 1 0-2Zm0 4h6a1 1 0 0 1 0 2h-6a1 1 0 0 1 0-2Z" />
        </svg>
      </div>
...
export function AppNotes() {
  ...
  const meta = app?.meta;
  if (!metaHasUsernamePassword(meta) && !metaHasNote(meta)) return null;
