...
import { PanelLeftClose, PanelLeftOpen, Server, Package, FileText, FolderOpen } from "lucide-react";
...
function buildHierarchyFromContext(indexData: any): HierarchyNode[] {
    ...
    apps.forEach((app: any) => {
      ...
      if (app.ui && app.ui.groups && app.ui.groups.length > 0) {
        ...
        if (firstGroup.pages && firstGroup.pages.length > 0) {
          firstGroup.pages.slice(0, 2).forEach((page: any) => { // Limit to 2 pages per app
