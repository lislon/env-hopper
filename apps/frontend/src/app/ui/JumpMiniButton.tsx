    ...
    return (
      <div className="relative">
        <JumpUrl app={app} env={env} substitution={substitution}>
          <div
            className="border border-dashed border-black dark:border-white rounded flex justify-center p-2 hover:border-solid hover:bg-gray-100 dark:hover:bg-gray-700 flex-col">
