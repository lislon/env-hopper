...
export type Action = PageJumpAction | ConfigSearchAction | EnvSelectionAction | AppSelectionAction | AppPageSelectionAction | EnvAction;
...
export interface AppPageSlug { app: string, page: string }
