  ...
  const form = useForm<FormData>({
    ...
    defaultValues: app
      ? {
          ...
          accessType: (
            app.access as { type?: unknown }
          ).type as AccessType || 'self-service',
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-4xl space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Array of link objects with url and optional displayName
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
          ...
          {!isNew && (
            <ScreenshotManager
              screenshots={
                (app as { screenshotIds?: Array<string> })?.screenshotIds?.map(
                  (id) => ({
                    id,
                    url: `/api/assets/${id}`,
                  }),
